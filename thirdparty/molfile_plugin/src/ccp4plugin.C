...
//
// Recent MRC/CCP4 format extension proposals for cryo-EM/ET
...
// Generic data flags (plugin-internal)
#define DATA_FLAG_SIGNED               0x1 
#define DATA_FLAG_IMOD_FORMAT          0x2
